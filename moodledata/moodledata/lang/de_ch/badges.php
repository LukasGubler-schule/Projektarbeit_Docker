...
/**
 * Strings for component 'badges', language 'de_ch', version '4.5'.
 *
 * @package     badges
 * @category    string
...
$string['coursecompletion'] = 'Teilnehmende müssen diesen Kurs abschliessen.';
$string['criteria_5'] = 'Mehrere Kurse abschliessen';
$string['criteria_descr_4'] = 'Teilnehmende müssen den Kurs abschliessen.';
$string['criteria_descr_short4'] = 'Kurs abschliessen';
$string['criteria_descr_single_4'] = 'Teilnehmende müssen den Kurs abschliessen.';
$string['criteria_descr_single_short1'] = 'Abschliessen:';
$string['criteria_descr_single_short4'] = 'Kurs abschliessen';
$string['criteria_descr_single_short5'] = 'Abschliessen:';
$string['criteria_descr_single_short6'] = 'Abschliessen:';
$string['criteria_descr_single_short7'] = 'Abschliessen:';
$string['criteria_descr_single_short9'] = 'Abschliessen:';
...
$string['sitebadges_help'] = 'Website-Badges können nur für systemweite Leistungen verliehen werden, wie z.B. das Abschliessen mehrerer Kurse oder die Vervollständigung des Nutzerprofils. Website-Badges können auch manuell von einer Person an eine andere verliehen werden.

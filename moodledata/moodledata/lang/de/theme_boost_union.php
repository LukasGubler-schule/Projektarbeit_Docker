...
$string['courselistinghowfields'] = 'Kursfelder in der Kursliste anzeigen';
...
<ul><li>Statisch: Ein statisches Menüelement ist einfach ein Link zu einer festen URL, die sich nicht ändert.</li>
<li>Überschrift: Eine Überschrift wird verwendet, um zusammengehörige Menüelemente unter einer gemeinsamen Überschrift zu gruppieren. Das Menüelement verfügt über keinen Link und ist nicht anklickbar.</li>
<li>Moodle-Dokumentation: Ein Menüpunkt der Moodle-Dokumentation dient zum Verlinken auf den entsprechenden Artikel in den MoodleDocs, ähnlich dem MoodleDocs-Link, der sich in der Moodle-Fußzeile (Fragezeichen-Symbol) befindet.</li>
<li>Dynamische Kurse: Ein Menüelement für dynamische Kurse wird verwendet, um eine Liste von Kursen basierend auf bestimmten Kriterien anzuzeigen, wie z.B. Kurskategorie, Kursrolle, Kursabschlussstatus oder Datumsbereich. Der in einem Menüelement für dynamische Kurse angezeigte Inhalt wird automatisch aktualisiert, wenn sich die Kriterien ändern.</li></ul>';

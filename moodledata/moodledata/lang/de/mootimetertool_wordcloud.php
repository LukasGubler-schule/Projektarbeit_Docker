...
/**
 * Strings for component 'mootimetertool_wordcloud', language 'de', version '4.5'.
 *
...
$string['allowduplicateanswers'] = 'Teilnehmer/innen erlauben, dieselbe Antwort mehrmals einzureichen';
$string['answers_max_number'] = 'Maximale Anzahl von Antworten pro Person (0: unbegrenzt)';
...
$string['no_answer_due_to_showteacherpermission'] = 'Trainer/in muss zunächst das Anzeigen der Antworten erlauben.';
...
$string['showresultteacherpermission'] = 'Ergebnisse nur mit Erlaubnis von Trainer/in anzeigen';

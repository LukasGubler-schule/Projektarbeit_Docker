...
/**
 * Strings for component 'theme_boost_magnific', language 'de', version '4.5'.
 *
...
$string['choosereadme'] = 'Boost Magnific ist ein sorgfältig gestaltetes Thema, das Ihrem Moodle lebhafte Farben und eine fröhliche Atmosphäre verleiht.';
...
$string['course_access'] = 'Kurs betreten';
$string['course_moore'] = 'Weitere Details';
...
$string['privacy:metadata'] = 'Das Boost Magnific-Theme speichert keine persönlichen Daten über Benutzer.';
...
$string['vvveb_home_automatically_catalogo'] = 'Nicht bearbeiten. Dieser Block wird automatisch durch den Kurskatalog ersetzt.';
$string['vvveb_home_automatically_category'] = 'Nicht bearbeiten. Dieser Block wird automatisch durch die Kurskategorien ersetzt.';
$string['vvveb_home_automatically_my_course'] = 'Nicht bearbeiten. Dieser Block wird automatisch durch die Kurse ersetzt, in die die Person eingeschrieben ist.';
$string['vvveb_home_automatically_popular'] = 'Nicht bearbeiten. Dieser Block wird automatisch durch die am häufigsten besuchten Kurse ersetzt.';

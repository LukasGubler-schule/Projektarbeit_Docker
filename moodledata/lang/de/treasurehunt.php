...
/**
 * Strings for component 'treasurehunt', language 'de', version '4.5'.
 *
...
$string['customlayerservicearcgis'] = 'Arcgis REST Tile Dienst (experimentell)';
$string['customlayerserviceimage'] = 'Bild hochladen';
$string['customlayerservicetiled'] = 'Gekacheltes XYZ-Bild';
$string['customlayerservicetype'] = 'Art der nutzerdefinierten Ebene';
$string['customlayerservicetype_help'] = 'Die nutzerdefinierte Ebene kann ein WMS Dienst, ein {x}{y}{z} Tiles Server, ein ArcGIS REST Tile Dienst (experimentell) oder ein hochgeladenes Bild sein.';
$string['customlayerservicewms'] = 'WMS-Dienst';
...
$string['customlayerwms'] = 'Webkartendienst URL (WMS, Tiles Server XYZ)';
$string['customlayerwms_help'] = 'Verwenden Sie eine Kartenebene eines OGC WMS-Dienstes oder eines ArcGIS REST Tile Servers. Beispiel:
<ul><li>
\'EUNIS Forest Ecosystems WMS\' kann folgendermaßen konfiguriert werden:
WMS: <code style="overflow-wrap: break-word;word-wrap: break-word;">http://bio.discomap.eea.europa.eu/arcgis/services/Ecosystem/Ecosystems/MapServer/WMSServer</code> PARAMS: <code>LAYERS=4</code>)</li><li>XYZ Tiles Dienst (nur für Spanien) <code>https://tms-ign-base.idee.es/1.0.0/IGNBaseTodo/{z}/{x}/{-y}.jpeg</code></li><li>(Experimentell) ArcGIS Rest Tile Dienste beispielsweise <code>http://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer</code> oder <code>https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer</code></li></ul>';
...
$string['custommaplayertype'] = 'Art der nutzerdefinierten Ebene';
$string['custommaplayertype_help'] = 'Die nutzerdefinierte Ebene kann nur im Hintergrund sichtbar sein oder über den Standard-Karten platziert werden.';
...
$string['custommapnolayer'] = 'Keine nutzerdefinierte Karte';
$string['custommapnongeographic'] = 'Das Bild ist nicht geographisch und ist die einzige Ebene der Karte.';
...
$string['custompreserveaspectratio'] = 'Seitenverhältnis beibehalten';
$string['custompreserveaspectratio_help'] = 'Wenn diese Option aktiviert ist, wird das Bild (Ost-West) so skaliert, dass es der geografischen Breite (Nord-Süd) entspricht, wobei das Seitenverhältnis beibehalten wird. Dies ist erforderlich, damit SVG-Bilder ohne Pixelbildung dargestellt werden können.';
$string['customwmsparams'] = 'Zusätzliche Parameter des Webkartendienstes';
...
$string['localizationbuttondisabled'] = 'Ortungsbutton deaktivieren';
$string['localizationbuttondisabled_help'] = 'Wenn die Option aktiviert ist, wird der Ortungsbutton in der Player-Oberfläche deaktiviert.';
...
$string['searchpaneldisabled'] = 'Suchpanel im Player deaktivieren';
$string['searchpaneldisabled_help'] = 'Wenn die Option aktiviert ist, wird das Suchpanel in der Player-Oberfläche deaktiviert.';
$string['send'] = 'Senden';
...
$string['treasurehunt:enterplayer'] = 'Zugriff auf die Player-Schnittstelle';

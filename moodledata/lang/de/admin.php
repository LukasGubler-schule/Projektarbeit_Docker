...
$string['importantupdates_content'] = '<p>In der Version Moodle 5.0, deren Veröffentlichung für April 2025 geplant ist, werden die Chat- und Umfrageaktivitäten aus dem Moodle-Kern entfernt. Sie werden dann aber als Plugins im
<a href="https://moodle.org/plugins/">Moodle-Plugin-Verzeichnis</a> verfügbar sein. Dies betrifft nicht die Aktivitäten Feedback oder Befragung (Questionnaire).</p>
<p>Wenn Sie Chat oder Umfrage weiterhin auf Ihrer Website verwenden möchten, können Sie diese als Plugins installieren, bevor Sie auf Moodle 5.0 aktualisieren.</p>';
$string['importantupdates_title'] = 'Wichtige Aktualisierungen bei Chat- und Umfrageaktivitäten';
...
$string['lockoutemailbody'] = 'Guten Tag  {$a->fullname},

...
/**
 * Strings for component 'quiz', language 'de_ch', version '3.10'.
 *
 * @package     quiz
 * @category    string
...
$string['completionpassdesc'] = 'Teilnehmer/in muss eine Bestehensgrenze erreichen, um diese Aktivität abzuschliessen';

...
$string['addon.messageoutput_airnotifier.pushdisabledwarning'] = 'Ihre Nutzer/innen erhalten auf ihren mobilen Geräten keine Benachrichtigungen dieser Website. Aktivieren Sie die mobilen Benachrichtigungen in den Einstellungen für Systembenachrichtigungen.';
...
$string['addon.storagemanager.info'] = 'Auf Ihrem Gerät gespeicherte Dateien beschleunigen die App und ermöglichen die Offline-Nutzung. Sie können Dateien sicher entladen, wenn Sie Speicherplatz freigeben müssen.';
...
- einfach auf Kursinhalte zugreifen, auch wenn Sie offline sind
...
$string['core.course.askadmintosupport'] = 'Fragen Sie die Administrator/innen der Website, um diese Aktivität mit der mobilen App verwenden zu können.';
...
$string['core.errorinvalidresponse'] = 'Ungültige Antwort für den Webservice {{method}} empfangen.';
...
$string['core.login.faqcannotfindmysiteanswer'] = 'Wenn Sie den Namen nicht finden können, wenden Sie sich bitte an Ihre Schule oder Ihren Lernanbieter, um Hilfe zu erhalten.';
$string['core.login.faqcannotfindmysitequestion'] = 'Ich kann meine Website nicht über die Adresse finden.';
...
$string['core.login.faqwhatisurlanswer'] = '<p>Wenn Sie Ihre Website nicht über den Namen finden können, suchen Sie stattdessen nach der Adresse.</p><p>Um diese Website-Adresse zu finden:</p><ol><li>Öffnen Sie Ihren Webbrowser und gehen Sie zur Anmeldeseite Ihres Moodle.</li><li>Oben in der Adressleiste sehen Sie die URL, z.B. "campus.example.edu".<br>{{$image}}</li><li>Kopieren Sie die Adresse (ohne /login und ohne den Rest dahinter), fügen Sie diese Adresse in die Moodle-App ein und tippen Sie auf "Verbinden!"</li><li>Jetzt können Sie sich mit Ihrem Anmeldenamen und dem Kennwort anmelden.</li></ol>';
...
$string['core.login.faqwhereisqrcodeanswer'] = '<p>Wenn Ihre Schule oder Ihr Lernanbieter dies aktiviert hat, finden Sie einen QR-Code auf der Seite mit Ihrem Nutzerprofil.</p>{{$image}}';
...
$string['core.login.invalidmoodleversion'] = 'Ungültige Moodle-Version. Die Moodle-App unterstützt nur Moodle-Systeme ab {{$a}}.';
...
$string['core.settings.spaceusagehelp'] = 'Nach dem Löschen der gespeicherten Daten können Sie die Kurse dieser Website nicht mehr ohne Internetverbindung in der App  verwenden.';
...
$string['freemium.autologouttitle'] = 'Automatische Abmelden von diesem Gerät';
...
$string['freemium.biometricloginloginwithfaceid'] = 'Anmelden per Gesicht';
...
$string['freemium.biometricloginturnoff'] = 'Sie können diese Funktion jederzeit unter Einstellungen ein- und ausschalten.';
...
$string['freemium.feature_multimediapushnotifications'] = 'Multimedia-Push-Benachrichtigungen';
$string['freemium.feature_pushnotificationsdevices'] = 'Geräte mit Push-Benachrichtigungen';
$string['freemium.feature_qrlogin'] = 'Authentifizieren mit einem QR-Code';
...
$string['freemium.qrlogindisabled'] = 'Die Authentifizierung in der App über einen QR-Code ist für die Website nicht aktiviert:<br><br>{{url}}';
...
$string['freemium.qrloginipmismatch'] = 'Das Gerät, mit dem Sie eine Verbindung herstellen, scheint sich in einem anderen Netzwerk zu befinden als das Gerät, das den QR-Code anzeigt. Stellen Sie bitte sicher, dass beide Geräte mit demselben Netzwerk verbunden sind (z.B. dasselbe WLAN).<br><br>Wenn der Fehler weiterhin besteht, wenden Sie sich bitte an die Administrator/innen.';
...
$string['freemium.ratetheapp_sendtostore'] = 'Könnten Sie sich bitte einen Moment Zeit nehmen, um unsere App zu bewerten? Es wird uns helfen, die App zu verbessern.';
...
$string['freemium.subscriptionfeature_exceeded_remotethemes'] = 'Ihr nutzerdefinierteS Design wird nicht verwendet.';
...
$string['freemium.subscriptionplandescription'] = 'Die Abonnementspläne zeigen auf, welche Einschränkungen für diese Website bestehen.';
$string['freemium.subscriptionplanlearnmore'] = 'Erfahren Sie mehr';
...
$string['freemium.upsell_upgradefreemessage'] = 'Sie nutzen aktuell den freien Plan. Erweitern Sie diesen, um mehr Möglichkeiten freizuschalten.';

...
$string['badpowersupply'] = '<p><b>Achtung: Die Spannung ist zu niedrig!</b> Die Stromversorgung der MoodleBox ist nicht ausreichend. Dies könnte Probleme verursachen, z.B. die Anzahl von WLAN-Clients begrenzen oder die MoodleBox unerwartet herunterfahren.</p>
<p>Verwenden Sie bitte die offizielle Stromversorgung <a href="https://www.raspberrypi.com/products/micro-usb-power-supply/" target="_blank"> für Raspberry Pi 3A+, 3B, 3B+ und Zero 2 W </a> bzw. <a href="https://www.raspberrypi.org/products/type-c-power-supply/" target="_blank"> für Raspberry Pi 4B </a>.</p>';
...
$string['restartstop_help'] = 'Verwenden Sie diese Tasten zum Neustarten oder Ausschalten der MoodleBox. Es wird dringend empfohlen, die MoodleBox per Softwar auszuschalten und erst danach die Stromversorgung zu trennen.';
...
$string['showbuttonsinfooter_desc'] = 'Diese Option legt fest, dass die Tasten zum Neustarten und Ausschalten im Fußbereich aller Seiten angezeigt werden, wenn Sie als Administrator/in oder Manager/in angemeldet sind.';
...
<p><b>Prüfen Sie Ihr Netzteil.</b> Verwenden Sie möglichst das <a href="https://www.raspberrypi.com/products/micro-usb-power-supply/" target="_blank"> Raspberry Pi 12,5 W Micro-USB-Netzteil </a> für Raspberry Pi 3A+, 3B, 3B+ und Zero 2 W oder das <a href="https: //www.raspberrypi.com/products/type-c-power-supply/" target="_blank"> Raspberry Pi 15 W USB-C-Netzteil </a> für Raspberry Pi 4B.</p>';

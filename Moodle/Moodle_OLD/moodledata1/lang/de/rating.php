...
$string['rolewarning_help'] = 'Nutzer/innen benötigen das Recht moodle/rating:rate und modulspezifische Rechte, um Bewertungen durchführen zu können. Nutzer/innen mit folgenden Rollen sollten Beiträge bewerten können. Eine Anpassung ist über \'Rechte ändern\' in der Kursnavigation oder im Block \'Administration\' möglich.';

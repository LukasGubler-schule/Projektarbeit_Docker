...
/**
 * Strings for component 'plagiarism_copyleaks', language 'de', version '3.10'.
 *
...
$string['cldefaultrepositoriespagetitle'] = 'Copyleaks-Standard-Repository-Einstellungen';
$string['cldefaultsettings'] = 'Standardeinstellungen des Copyleaks-Plagiatsplugins';
...
$string['cleditrepositories'] = 'Repositories-Einstellungen bearbeiten';
$string['clenable'] = 'Copyleaks aktivieren';
$string['clenablecheatdetection'] = 'Cheat-Erkennung aktivieren';
$string['clenablemodulefor'] = 'Copyleaks für {$a} aktivieren';
$string['clenablesafesearch'] = 'Sichere Suche aktivieren';
$string['clfailtoloaddata'] = 'Copyleaks-Daten konnten nicht geladen werden';
...
$string['clignorequotes'] = 'Anführungszeichen ignorieren';
$string['clignorereferences'] = 'Referenzen ignorieren';
$string['clignoreresourcecodecomments'] = 'Kommentare zum Quellcode ignorieren';
$string['clignoreretableofcontents'] = 'Inhaltsverzeichnis ignorieren';
$string['clignoretitles'] = 'Titel ignorieren';
...
$string['clrepositoriespagetitle'] = 'Copyleaks-Repositories-Einstellungen';
$string['clscaninternaldatabase'] = 'Interne Datenbank scannen';
$string['clscaninternet'] = 'Internet scannen';

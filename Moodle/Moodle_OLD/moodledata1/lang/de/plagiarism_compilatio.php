...
$string['privacy:metadata:plagiarism_compilatio_files:apiconfigid'] = 'Die Kennung der API-Konfiguration, mit der die Übermittlung verknüpft ist';
...
$string['privacy:metadata:plagiarism_compilatio_files:errorresponse'] = 'Die Antwort, wenn ein Fehler aufgetreten ist - dieses Feld wird derzeit nicht mehr verwendet und automatisch auf \'NULL\' gesetzt.';
...
$string['privacy:metadata:plagiarism_compilatio_files:idcourt'] = 'Die in der Compilatio-Datenbank gespeicherte Kurz-ID des Beitrags';
$string['privacy:metadata:plagiarism_compilatio_files:identifier'] = 'Der contenthash der Einreichung';
$string['privacy:metadata:plagiarism_compilatio_files:recyclebinid'] = 'Die Kennung des Papierkorbs, falls der Kursbaustein oder der Kurs in den Papierkorb verschoben wurde';
...
$string['subscription_state'] = '<strong>Ihr Compilatio-Abonnement läuft am Ende von {$a->Enddatum} ab.</strong>';
...
$string['waiting_time_content'] = 'Einschließlich {$a->queue} in der Warteschlange und {$a->analysis_time} der Analyse<br><br>Klicken Sie <a href=\'../../plagiarism/compilatio/helpcenter.php?page=moodle-info-waiting&idgroupe=';
$string['waiting_time_content_help'] = '\' target=\\\'_blank\\\'>hier</a> finden Sie die besten Praktiken, um die Verarbeitungszeit von Compilatio-Analysen zu optimieren.';
$string['waiting_time_title'] = 'Die geschätzte Bearbeitungszeit für eine jetzt gestartete Analyse beträgt';
